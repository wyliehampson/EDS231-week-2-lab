...
This code chunk plots the number of articles published per date, so we can see which days published the most relevant articles on the search. We see 11/10/2021 had 7 articles about elevtric vehicles published that day.
...
This code chunk takes all of the words from the word column and creates a histogram. However, notice that stop words are still included.
...
These are the results without stop words included.
...
This code cleans up the above plot by getting rid of number strings, 
